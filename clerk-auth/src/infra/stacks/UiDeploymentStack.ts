...
export class UiDeploymentStack extends Stack {
    constructor(scope: Construct, id: string, props: StackProps) {
        ...
        const deploymentBucket = new Bucket(this, "ClerkAuthFrontend", {
            bucketName: `clerk-auth-ui-bucket-${suffix}`,
        ...
        if (existsSync(uiDir)) {
            new BucketDeployment(this, "ClerkAuthUiDeployment", {
            ...
            new CfnOutput(this, "ClerkAuthUiDeploymentS3Url", {
